...
4. On the "_Specify stack details_" screen you may customize the following parameters of the CloudFormation stack:
   ...
   - **TopicArn:** (Default: false) When providing a SNS Topic Arn, it sends SNS notifications for each body part detected. The SNS Topic and the Demo need to be located in the same AWS Region.
